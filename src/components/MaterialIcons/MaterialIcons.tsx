...
/**
 * @note doing it this way would not scale for too many icons since it cannot be dead code eliminated
 * @note could be a switch, or an object, but this is the most uglifiable
 */
export function fromIconNameToPath(name: IconNameType) {
  if (name === 'facebook') {
    ...
    return 'M15 1H9v2h6V1zm-4 13h2V8h-2v6zm8.03-6.61l1.42-1.42c-.43-.51-.9-.99-1.41-1.41l-1.42 1.42C16.07 4.74 14.12 4 12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9 9-4.03 9-9c0-2.12-.74-4.07-1.97-5.61zM12 20c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z'
    ...
    return 'M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 9h12v2H6V9zm8 5H6v-2h8v2zm4-6H6V6h12v2z'
  } else if (name === 'plane') {
    ...
    if (process.env.NODE_ENV === 'development') {
      throw new Error('must pass in icon name')
    }
    return ''
  }
}
